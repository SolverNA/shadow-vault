...
export interface PluginSettings {
  ...
  /**
   * @deprecated internal — больше НЕ читается логикой и НЕ редактируется в UI.
   * Путь к теневому хранилищу всегда вычисляется автоматически
   * (детерминированно по хешу basePath). Поле сохранено только ради
   * обратной совместимости со старыми data.json (чтобы загрузка не падала).
   */
